<!--
This is the project specification for GitHub Copilot Agent.
Use this document as a reference to understand:
- Project purpose
- Features
- Data flow
- Database schema
- Expected behavior and analytics logic

Do not alter unless updating the spec.
-->
# Crystal Balance – Personal Finance Tracker with Smart Analytics
